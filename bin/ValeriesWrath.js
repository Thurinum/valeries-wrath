...
var wasmBinaryFile;
  wasmBinaryFile = 'ValeriesWrath.wasm';
...
function qt_have_asyncify_js() { return typeof Asyncify != "undefined"; }
  ...
  var GL = {debug:true,counter:1,buffers:[],programs:[],framebuffers:[],renderbuffers:[],textures:[],shaders:[],vaos:[],contexts:[],offscreenCanvases:{},queries:[],samplers:[],transformFeedbacks:[],syncs:[],stringCache:{},stringiCache:{},unpackAlignment:4,recordError:function recordError(errorCode) {
        if (!GL.lastError) {
